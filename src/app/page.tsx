...
import logoRR from '@/images/logos/rr.svg'
import logoAC from '@/images/logos/AC.svg'
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'Edwards - Atlas Copco',
      title: 'Senior Manager - Industry 4.0',
      logo: logoAC,
      start: '2014',
      end: '2019',
    },
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://drive.google.com/file/d/1gDQwNXv1t8mZcDxWdCQukZLbeh04Tfke/view?usp=drive_link" variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software developer, founder, and industry 4.0 expert.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Tom, a software developer and entrepreneur based in Sussex. I’m the founder of FactoryPulse, where we develop
            applications that empower manufacturing businesses to transform their operations.
          </p>
          <div className="mt-6 flex gap-6">

            <SocialLink
              href="https://www.linkedin.com/in/thomasdarcyuk/"
