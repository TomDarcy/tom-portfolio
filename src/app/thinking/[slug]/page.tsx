          ...
          <article>
            ...
            <div className="mt-12 pt-8 border-t border-[var(--border)]">
              ...
              >
                <label
                  htmlFor="bd-email"
                  className="font-headline text-lg font-semibold text-[var(--foreground)]"
                >
                  Enter your email
                </label>
                <input
                  ...
                  required
                  className="rounded-md border border-[var(--border)] bg-[var(--card)] px-4 py-2 text-sm text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] focus:outline-none focus:ring-2 focus:ring-amber-500"
                />
                <input
                  type="submit"
                  value="Subscribe"
                  className="cursor-pointer rounded-md bg-amber-500 px-4 py-2 text-sm font-medium text-black hover:bg-amber-400 transition-colors"
                />
                <p className="text-xs text-[var(--muted-foreground)]">
                  <a
                    href="https://buttondown.com/refer/darcy"
                    target="_blank"
