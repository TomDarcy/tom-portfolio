...
export function Button({
  ...
  const baseStyles = cn(
    ...
    {
      // Variants
      "bg-amber-500 text-charcoal-900 hover:bg-amber-400 shadow-md hover:shadow-lg hover:shadow-amber-500/25":
        variant === "primary",
      "border-2 border-[var(--border)] text-[var(--foreground)] hover:border-amber-500 hover:text-amber-500 hover:shadow-md":
        variant === "secondary",
